...
// 배열 선언
// let friends = ["혜빈","현진","길동","민준","시연"]
let friends = "혜빈,현진,길동,민준,시연".split(",");
...
console.log(friends); // ['보영', '선범', '현진', '길동', '민준', '시연']

let push = friends.push("지민");
console.log(friends); //['보영', '선범', '현진', '길동', '민준', '시연', '지민']

// 배열 요소 제거
let shift = friends.shift();
console.log(shift); // 보영
